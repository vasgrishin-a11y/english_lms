...
- **Шаблоны квизлетов** — в форме «Новый квизлет» и на странице карточек: 14 готовых наборов по темам и уровням (A1–C1). Клик подставляет название и описание, карточки создаются при сохранении; на странице карточек шаблон можно подставить в массовый импорт для правок или добавить сразу. Квизлет привязан к теме и показывается строкой-заданием и у преподавателя на карте курса, и у ученика.
