...
TEXTS_EN = {
    ...
    "Создать класс": "Create class",
    "Новый класс": "New class",
    "Изменить класс": "Edit class",
    "Новая глава": "New chapter",
    "Изменить главу": "Edit chapter",
    ...
    "Удалить класс целиком": "Delete class with contents",
    "Удалить главу целиком": "Delete chapter with contents",
    ...
    "Архивировать класс": "Archive class",
    "Архивировать главу": "Archive chapter",
    ...
    "Собрать класс из материала": "Build class from material",
    "Пароль и профиль": "Password and profile",
    "Кому доступно": "Who can see it",
    "К очереди проверки": "To review queue",
    "Правка задания с ИИ": "Edit assignment with AI",
