...
DECK_PRESETS = [
    ...
    },
    {
        ...
        "cards": [
            {"front": "departure", "back": "отправление, вылет", "example": "Our departure time is 7 a.m."},
            {"front": "to check in", "back": "регистрироваться (на рейс)", "example": "We checked in online."},
            {"front": "boarding pass", "back": "посадочный талон", "example": "Show your boarding pass at the gate."},
            {"front": "luggage", "back": "багаж", "example": "How many pieces of luggage?"},
            {"front": "to book", "back": "бронировать", "example": "I booked a hotel near the beach."},
            {"front": "return ticket", "back": "билет туда-обратно", "example": "A return ticket is cheaper."},
            {"front": "delay", "back": "задержка", "example": "The flight was delayed by two hours."},
            {"front": "sightseeing", "back": "осмотр достопримечательностей", "example": "We went sightseeing in Rome."},
            {"front": "journey", "back": "поездка", "example": "The journey took five hours."},
            {"front": "harbour", "back": "гавань, порт", "example": "The old harbour is beautiful."},
        ],
    },
    {
        "id": "hotel-a2",
        ...
        "cards": [
            ...
            {"front": "single room", "back": "одноместный номер", "example": "I booked a single room."},
    ...
    },
    {
        ...
        "cards": [
            ...
            {"front": "to pass an exam", "back": "сдать экзамен", "example": "She passed the exam."},
            ...
            {"front": "to revise", "back": "повторять (материал)", "example": "Revise the words daily."},
        ],
    },
    {
        "id": "phrasal-b1",
        ...
        "cards": [
            {"front": "to carry out", "back": "проводить, выполнять", "example": "We carried out a survey."},
            {"front": "to put off", "back": "откладывать", "example": "Don't put off your homework."},
            {"front": "to look into", "back": "изучать", "example": "I'll look into this problem."},
            {"front": "to come up with", "back": "придумать", "example": "She came up with a great idea."},
            {"front": "to hand in", "back": "сдавать (работу)", "example": "Hand in your essays by Friday."},
            {"front": "to catch up on", "back": "наверстать", "example": "I need to catch up on sleep."},
            {"front": "to take on", "back": "брать на себя", "example": "He took on extra work."},
            {"front": "to fall behind", "back": "отставать", "example": "Don't fall behind the schedule."},
            {"front": "to find out", "back": "выяснять", "example": "I found out the truth."},
            {"front": "to run out of", "back": "исчерпать (запас)", "example": "We ran out of time."},
        ],
    },
    {
        "id": "business-b1",
        ...
        "cards": [
            ...
            {"front": "target audience", "back": "целевая аудитория", "example": "Our target audience is 25–35."},
            ...
            {"front": "meeting", "back": "встреча, совещание", "example": "The meeting starts at 10."},
            {"front": "deadline", "back": "дедлайн", "example": "We missed the deadline."},
            {"front": "feedback", "back": "обратная связь", "example": "Customer feedback was positive."},
            {"front": "stakeholder", "back": "заинтересованная сторона", "example": "We informed all stakeholders."},
        ],
    },
    {
        "id": "movie-b1",
    ...
    },
    {
        ...
        "cards": [
            {"front": "to deploy", "back": "выкатывать, деплоить", "example": "We deploy on Fridays."},
    ...
    },
    {
        ...
        "cards": [
            {"front": "to make a decision", "back": "принимать решение", "example": "We made a decision quickly."},
            {"front": "to do research", "back": "проводить исследование", "example": "She does research at uni."},
            {"front": "to take responsibility", "back": "брать ответственность", "example": "He took responsibility."},
            {"front": "to get feedback", "back": "получать обратную связь", "example": "We got useful feedback."},
            {"front": "to make an effort", "back": "прилагать усилия", "example": "Make an effort daily."},
            {"front": "to do a favour", "back": "оказать услугу", "example": "Could you do me a favour?"},
            {"front": "to take a break", "back": "делать перерыв", "example": "Let's take a break."},
            {"front": "to get permission", "back": "получать разрешение", "example": "Get permission first."},
            {"front": "to make progress", "back": "делать успехи", "example": "You make good progress."},
            {"front": "to take notes", "back": "делать заметки", "example": "Take notes during the talk."},
        ],
    },
    {
        "id": "ielts-b2",
        ...
        "cards": [
            {"front": "to increase", "back": "увеличиваться", "example": "Prices increased sharply."},
    ...
    },
    {
        ...
        "cards": [
            ...
            {"front": "to reassure", "back": "успокоить, заверить", "example": "I reassured the client."},
            {"front": "follow-up", "back": "последующее письмо", "example": "I'll send a follow-up."},
            {"front": "downtime", "back": "простой", "example": "Sorry for the downtime."},
            {"front": "to prioritise", "back": "расставлять приоритеты", "example": "We prioritised the fix."},
            {"front": "resolution", "back": "решение (проблемы)", "example": "Thanks for the quick resolution."},
